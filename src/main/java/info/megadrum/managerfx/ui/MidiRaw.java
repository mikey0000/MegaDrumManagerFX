...
public class MidiRaw extends VBox {
    ...
    private final List<String> listOfHtmlLines;
    private final StringBuilder htmlHead;
    private final StringBuilder htmlTail;

    private final VBox vBoxHeader;
    ...
    public MidiRaw() {
        ...
        listOfHtmlLines = new ArrayList<>();

        String formatStringHeader = "%-16s %-5s %-6s %-6s %-6s   %-6s   %-30s\n";
    ...
    public void addRawMidi(byte[] buffer) {
        ...
        timeDiff = (double) (System.nanoTime() - prevTime) / 1000000000;
        prevTime = System.nanoTime();
