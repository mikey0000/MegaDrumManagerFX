...
public class UIPad extends UIPanel implements PanelInterface {
    ...
    private final UIInput uiInputLeft;
    private final UIInput uiInputRight;
    private final UI3rdZone ui3rdZone;
    ...
    private final Label labelInput;
    private final ComboBox<String> comboBoxInput;
    ...
    private final double inputsGap = 5.0;
    ...
    public void respondToResize(double w, double h, double cW, double cH) {
        ...
        comboBoxInput.setStyle("-fx-font-size: " + comboBoxFontHeight + "pt");
