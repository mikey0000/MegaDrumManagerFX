...
public class UIInput implements PanelInterface {
    ...
    private final UIComboBox uiComboBoxName;
    ...
    private final UISpinner uiSpinnerChannel;
    private final UIComboBox uiComboBoxFunction;
    private final UIComboBox uiComboBoxCurve;
    private final UIComboBox uiComboBoxCompression;
    private final UIComboBox uiComboBoxLevelShift;
    private final UIComboBox uiComboBoxXTalkLevel;
    private final UIComboBox uiComboBoxXTalkGroup;
    private final UISpinner uiSpinnerThreshold;
    private final UIComboBox uiComboBoxGain;
    private final UICheckBox uiCheckBoxHighAuto;
    private final UISpinner uiSpinnerHighLevel;
    private final UISpinner uiSpinnerRetrigger;
    private final UIComboBox uiComboBoxDynLevel;
    private final UIComboBox uiComboBoxDynTime;
    private final UISpinner uiSpinnerMinScan;
    private final UIComboBox uiComboBoxRollSmoothLevel;
    private final UICheckBox uiCheckBoxExtraFalse;
    private final UIComboBox uiComboBoxPosLevel;
    private final UISpinner uiSpinnerPosLow;
    private final UISpinner uiSpinnerPosHigh;
    private final UIComboBox uiComboBoxType;
    ...
    public void respondToResize(Double w, Double h, Double controlW, Double controlH) {
        ...
        for (UIControl allControl : allControls) {
            ...
            if (showControl) {
                ...
                allControl.getUI().setLayoutY(visibleControlsCount * controlH + controlH);
            }
        }
    }
    ...
    public void setHeadEdgeType(int type) {
        if (type == Constants.PAD_TYPE_HEAD) {
            ...
            for (UIControl allControl : allControls) {
                allControl.setButtonCopyToolTip("Copy this setting to All inputs");
            }
        }
        if (type == Constants.PAD_TYPE_EDGE) {
            listInputType = Arrays.asList(Constants.PAD_TYPE_EDGE_LIST);
            for (UIControl allControl : allControls) {
                allControl.setButtonCopyToolTip("Copy head/rim setting to All pads");
            }
        }
