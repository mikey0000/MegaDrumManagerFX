...
public class UIGlobalMisc {
    ...
    private final ToggleButton toggleButtonMidi;
    private final Label labelInputs;
    private final ComboBox<String> comboBoxInputs;
    private List<String> listValuesInputs;
    private final Label labelFwVersion;
    private final Label lblFwVersion;
    private final Label labelLcdContrast;
    private final SpinnerFast<Integer> spinnerLcdContrast;
    private final Label labelMcu;
    private final Label lblMcu;
    private final Label labelConfigNamesEn;
    private final CheckBox checkBoxConfigNamesEn;
    private final Label labelPadsNamesEn;
    private final CheckBox checkBoxPadsNamesEn;
    private final Label labelSlotsCount;
    private final Label lblSlotsCount;
    private final Label labelSlotCurrent;
    private final Label lblSlotCurrent;
    private final TextField textSlotName;
    private final Label labelMidi2ForSysex;
    private final CheckBox checkBoxMidi2ForSysex;
    private final Button buttonGet;
    private final Button buttonSend;
    private final CheckBox checkBoxLiveUpdates;
    private final RadioMenuItem rbHide;
    private final RadioMenuItem rbShow;

    private final ArrayList<Label> allControlLabels;
    ...
    public UIGlobalMisc() {
        ...
        comboBoxInputs = new ComboBox<>();
        comboBoxInputs.setStyle("-fx-font-size: 9pt");
        comboBoxInputs.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<>() {
        ...
        checkBoxPadsNamesEn.selectedProperty().addListener(new ChangeListener<>() {
            @Override
        ...
        checkBoxConfigNamesEn.selectedProperty().addListener(new ChangeListener<>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
        ...
        spinnerLcdContrast = new SpinnerFast<>();
        spinnerLcdContrast.getEditor().textProperty().addListener(new ChangeListener<>() {
        ...
        SpinnerValueFactory<Integer> valueFactoryLcd = new SpinnerValueFactory.IntegerSpinnerValueFactory(0, 100, 50, 1);
        spinnerLcdContrast.setValueFactory(valueFactoryLcd);

        Label labelSlotName = new Label("Slot Name:");
        ...
        checkBoxMidi2ForSysex.selectedProperty().addListener(new ChangeListener<>() {
            @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {
        ...
        Label labelLiveUpdates = new Label("Live Updates");
        ...
        setAllStatesUnknown();
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(40.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(70.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(70.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(110.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(90.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(20.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(70.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(25.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(80.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(100.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(80.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(120.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(20.0));
    ...
    public void setAllStatesUnknown() {
        ...
        for (Label allControlLabel : allControlLabels) {
            allControlLabel.setTextFill(Constants.SYNC_STATE_UNKNOWN_COLOR);
        }
    ...
    public void respondToResize(Double h) {
        ...
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 1.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 1.6));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 1.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.3));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 0.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 1.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 0.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.0));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 2.5));
        rootGridPane.getColumnConstraints().add(new ColumnConstraints(h * 0.5));
        for (int i = 0; i < rootGridPane.getChildren().size(); i++) {
            ...
            if (rootGridPane.getChildren().get(i) instanceof ComboBox<?>) {
                rootGridPane.getChildren().get(i).setStyle("-fx-font-size: " + styledFontSize + "pt");
            }
        ...
        spinnerLcdContrast.setMinWidth(h * 1.3);
    }
    ...
    public void setConfigCurrent(int current) {
        int c = current + 1;
        lblSlotCurrent.setText(Integer.toString(c));
    ...
    public void setControlsFromConfig(ConfigGlobalMisc config, Boolean setFromSysex) {
        ...
        if (spinnerLcdContrast.getValueFactory().getValue() != config.lcd_contrast) {
    ...
    private void setMaxInputsCount() {
        int n = (56 - 16) / 2;
        if (listValuesInputs == null) {
            listValuesInputs = new ArrayList<>();
        }
