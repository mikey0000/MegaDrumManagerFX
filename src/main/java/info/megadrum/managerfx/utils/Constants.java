...
public interface Constants {
    ...
    public static final Double FX_BUTTONS_FONT_MAX_SIZE		= 10.0;
    public static final Double FX_BUTTONS_FONT_SCALE		= 0.28;
    public static final Double FX_COMBOBOX_FONT_MAX_SIZE	= 10.0;
